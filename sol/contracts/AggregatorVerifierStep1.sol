...
buf[99] = AggregatorLib.fr_pow(buf[6], 8388608);
buf[100] = addmod(buf[99], AggregatorLib.p_mod - 1, AggregatorLib.p_mod);
buf[101] = AggregatorLib.fr_div(mulmod(21888240262557392955334514970720457388010314637169927192662615958087340972065, buf[100], AggregatorLib.p_mod), addmod(buf[6], AggregatorLib.p_mod - 1, AggregatorLib.p_mod), aux[0]);
...
buf[103] = AggregatorLib.fr_div(mulmod(4976187549286291281196346419790865785215437125361463174887299780224677482739, buf[100], AggregatorLib.p_mod), addmod(buf[6], AggregatorLib.p_mod - 21710372849001950800533397158415938114909991150039389063546734567764856596059, AggregatorLib.p_mod), aux[1]);
...
buf[111] = addmod(addmod(addmod(AggregatorLib.fr_div(mulmod(17545179510056424625657753961500172777187948487824275719647175633757629801999, buf[100], AggregatorLib.p_mod), addmod(buf[6], AggregatorLib.p_mod - 1887003188133998471169152042388914354640772748308168868301418279904560637395, AggregatorLib.p_mod), aux[2]), AggregatorLib.fr_div(mulmod(12181902470161097505840471953356915228510866946798053228669051859673065660797, buf[100], AggregatorLib.p_mod), addmod(buf[6], AggregatorLib.p_mod - 2785514556381676080176937710880804108647911392478702105860685610379369825016, AggregatorLib.p_mod), aux[3]), AggregatorLib.p_mod), AggregatorLib.fr_div(mulmod(3094683119308499972127188652296432785995218440930254516456812473854441617488, buf[100], AggregatorLib.p_mod), addmod(buf[6], AggregatorLib.p_mod - 14655294445420895451632927078981340937842238432098198055057679026789553137428, AggregatorLib.p_mod), aux[4]), AggregatorLib.p_mod), AggregatorLib.fr_div(mulmod(17403859010271654340651602860211012227656903909453797585120745724534928821531, buf[100], AggregatorLib.p_mod), addmod(buf[6], AggregatorLib.p_mod - 8734126352828345679573237859165904705806588461301144420590422589042130041188, AggregatorLib.p_mod), aux[5]), AggregatorLib.p_mod);
buf[112] = addmod(1, AggregatorLib.p_mod - addmod(buf[103], addmod(buf[111], AggregatorLib.fr_div(mulmod(7444483286096152693477325065105185543054922671492455540957072536952082259082, buf[100], AggregatorLib.p_mod), addmod(buf[6], AggregatorLib.p_mod - 9741553891420464328295280489650144566903017206473301385034033384879943874347, AggregatorLib.p_mod), aux[6]), AggregatorLib.p_mod), AggregatorLib.p_mod), AggregatorLib.p_mod);
